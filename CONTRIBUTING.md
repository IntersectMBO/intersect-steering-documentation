# Contributing to the Intersect Steering Committee documentation

## Table of Contents

- [Contributing to the Intersect Steering Committee documentation](#contributing-to-the-Intersect Steering-committee-documentation)
...
1. **Fork the repository:**
   - Navigate to  https://github.com/Intersect Steering/Intersect Steering-committee-documentation
...
2. **Clone the fork:**
   ...
   - Run the following command to clone the repository:
     ```shell
     git clone https://github.com/Intersect Steering/Intersect Steering-committee-documentation.git
     ```

3. **Navigate to the Project Directory:**
   - After cloning, change into the project's root directory:
     ```shell
     cd Intersect Steering-committee-documentation
     ```
