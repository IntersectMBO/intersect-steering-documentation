...
{% hint style="info" %}
This page is written on behalf of the Intersect Governance Working Group. The information contained is subject to change and amendment by the working group at any time.
{% endhint %}

## Purpose/Goals of the working group <a href="#purpose-of-this-working-group" id="purpose-of-this-working-group"></a>
